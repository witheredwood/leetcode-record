...
import leetcode_code.code137_0435;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

class code137_0435Test {
    code137_0435 one = new code137_0435();

    @Test
    void test1() {
        int[][] intervals = {{1,2}, {2,3}, {3,4}, {1,3}};
        Assertions.assertEquals(1, one.eraseOverlapIntervals(intervals));
    }

    @Test
    void test2() {
        int[][] intervals = {{1,2}, {1,2}, {1,2}, {1,2}};
        Assertions.assertEquals(3, one.eraseOverlapIntervals(intervals));
    }

    @Test
    void test3() {
        int[][] intervals = {{1,2}, {2,3}};
        Assertions.assertEquals(0, one.eraseOverlapIntervals(intervals));
    }

    @Test
    void test4() {
        int[][] intervals = {{-2,-1}, {2,3}};
        Assertions.assertEquals(0, one.eraseOverlapIntervals(intervals));
    }
